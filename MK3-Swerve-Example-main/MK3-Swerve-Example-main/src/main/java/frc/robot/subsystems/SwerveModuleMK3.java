...
public class SwerveModuleMK3 {
  ...
  private static double kEncoderTicksPerRotation = 1024;
  ...
  public SwerveModuleMK3(TalonFX driveMotor, TalonFX angleMotor, DutyCycleEncoder magEncoder, Rotation2d offset) {
    ...
    angleTalonFXConfiguration.remoteFilter0.remoteSensorDeviceID = magEncoder.getSourceChannel();
    angleTalonFXConfiguration.remoteFilter0.remoteSensorSource = RemoteSensorSource.Off;
  ...
  public Rotation2d getAngle() {
    ...
    return Rotation2d.fromDegrees(magEncoder.get());
  }
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    double currentTicks = magEncoder.get();
