...
public class SwerveDrivetrain extends SubsystemBase {
  ...
  private SwerveDriveKinematics kinematics = new SwerveDriveKinematics(
    new Translation2d(
      Units.inchesToMeters(15.905512),
      Units.inchesToMeters(15.905512)
    ),
    new Translation2d(
      Units.inchesToMeters(15.905512),
  ...
  private SwerveModuleMK3[] modules = new SwerveModuleMK3[] {
    new SwerveModuleMK3(new TalonFX(1), new TalonFX(2), new DutyCycleEncoder(0), Rotation2d.fromDegrees(0)), // Front Left
    new SwerveModuleMK3(new TalonFX(3), new TalonFX(4), new DutyCycleEncoder(1), Rotation2d.fromDegrees(0)), // Front Right
    new SwerveModuleMK3(new TalonFX(5), new TalonFX(6), new DutyCycleEncoder(8), Rotation2d.fromDegrees(0)), // Back Left
    new SwerveModuleMK3(new TalonFX(7), new TalonFX(8), new DutyCycleEncoder(9), Rotation2d.fromDegrees(0))  // Back Right
  };
